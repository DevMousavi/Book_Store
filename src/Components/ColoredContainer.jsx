...
export const ColoredContainer = ({ url, title, link, bg_color, img_title }) => {
    ...
    return (
        <div className="mb-20">
            ...
            <div
                className={`w-full h-[400px] my-3 rounded-xl ${bg_color} flex flex-col justify-center cardOfferShadow relative`}
            >
                <div className="absolute bottom-[-18px] right-16 max-w-52">
                    <img

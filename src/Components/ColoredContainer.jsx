...
export const ColoredContainer = ({ url, title, link, bg_color, img_title }) => {
    ...
    return (
        <div className="af:hidden as:flex as:flex-col mb-20  ">
            <div className="af:hidden as:flex justify-between items-center">
                <p className="font-bold lg:text-3xl af:text-xl af:mx-3 lg:mx-0 ">
                    {title}
                </p>
                <Link
                    to={link}
            ...
            >
                <div className="lg:absolute xl:flex af:hidden flex-col-reverse bottom-[-18px] right-16 max-w-52 ">
                    <img
                        src={`${process.env.PUBLIC_URL}/assets/colored-container/${img_title}.png`}
                        alt={img_title}
                    />
                </div>
